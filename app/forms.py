...
class VehicleShare(forms.ModelForm):
    date = forms.DateField(input_formats = ["%d.%m.%Y"],widget=forms.TextInput(
        attrs={'class': 'form-control', 'required': True,'data-date-start-date':'0d'}))
    start_time = forms.TimeField(input_formats = ["%H:%M"],
        widget=forms.TextInput(attrs={'class': 'form-control', 'required': True,}))
    arrival_time = forms.TimeField(input_formats = ["%H:%M"],
        widget=forms.TextInput(attrs={'class': 'form-control', 'required': True}))
